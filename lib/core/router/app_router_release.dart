...
import '../../features/pending/notifications/notification_diagnostics_unavailable_screen.dart';
...
final appRouterRelease = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (_, _) => const NotificationAccessSetupScreenSafe(),
    ),
    GoRoute(
      path: AppRoutes.notificationDiagnostics,
      builder: (_, _) => const NotificationDiagnosticsUnavailableScreen(),
    ),
    GoRoute(
    ...
    GoRoute(
      path: AppRoutes.logs,
      builder: (_, _) => const RouteFallbackScreen(
