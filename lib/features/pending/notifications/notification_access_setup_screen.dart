...
class NotificationAccessSetupScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final postNotifications = ref.watch(postNotificationsPermissionProvider);
        ...
        data: (settings) => LayoutBuilder(
          builder: (context, constraints) {
            final statusCard = _NotificationStatusCard(
              ...
              listenerAvailable: listenerAvailable,
              accessState: accessState,
              postNotifications: postNotifications,
              notificationIngestionAvailable: notificationIngestionAvailable,
              onOpenSettings: notificationIngestionAvailable
                  ? () async {
                      await ref
                          .read(notificationPermissionServiceProvider)
                          .openAccessSettings();
                      await _refreshBackgroundAccessStatus(ref);
                    }
                  : null,
              onAllowNotifications: postNotifications.valueOrNull == false
                  ? () async {
                      await ref
                          .read(notificationPermissionServiceProvider)
                  ...
                  : null,
              onRefresh: () => _refreshBackgroundAccessStatus(ref),
            );
            ...
            final sourcesCard = _FinancialAppSourcesCard(
              ...
              onDetectionChanged: (value) async {
                if (value && !hasNotificationAccess) {
              ...
              onPaymentAppsChanged: notificationIngestionAvailable
                  ? (value) => ref
                        .read(detectionSettingsProvider.notifier)
  ...
  static Future<void> _refreshBackgroundAccessStatus(WidgetRef ref) async {
    ...
    await ref
        .read(detectionSettingsProvider.notifier)
        .applyChanges(notificationDetectionEnabled: hasNotificationAccess);
  }
}
